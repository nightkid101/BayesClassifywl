...
public class Prediction {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        GetPriorProbability(otherArgs[0]+"/part-r-00000");
        GetConditionProbability(otherArgs[1]+"/part-r-00000",otherArgs[2]+"/part-r-00000",otherArgs[3]+"/part-r-00000");

        FileSystem hdfs = FileSystem.get(conf);

        /*设置Job*/
        Path path = new Path(otherArgs[5]);
        if(hdfs.exists(path))
