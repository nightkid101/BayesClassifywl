...
public class NaiveBayesBasedOnWord {
	...
	public static void main(String[] args) throws IOException {
		...
		Job job1 = new Job(conf, "WordCounts-><(class:word),counts>");
		...
		Job job2 = new Job(conf, "ClassTotalWords-><class:totalwords>");
		...
		Job job3 = new Job(conf, "DiffTotalWords-><word:1>");
		...
		Job job4 = new Job(conf, "Classify-><docID:class>");
	...
	public static HashMap<String, Double> GetConditionProbability() throws IOException{
		...
		String ClassTotalWordsPath = otherArgs[2];
		String DiffTotalWordsPath = otherArgs[3];
		String ClasswordcountsPath = otherArgs[1];
